...
import { glossaryTerms, quranicVerses, scholarlyWorks } from "@/data/glossary";
          ...
          >
            {filteredTerms.length > 0 ? (
              filteredTerms.map((term) => (
                <motion.div key={term.term} variants={staggerItem}>
        ...
        <section>
          ...
          >
            {quranicVerses.map((verse) => (
              <motion.div key={verse.reference} variants={staggerItem}>
